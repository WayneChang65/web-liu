...
> 2026-09-25 依主人第一輪試玩回報修 7 項：見下方「本輪變更」。
...
## 第三輪變更（2026-09-25 主人第三輪試玩 2 項回饋）
- `<font size="1～7">`（HackMD 的字級功能）在預覽也真渲染；編輯模式照舊
  顯示原始 HTML 源碼、不渲染任何顏色／字級——「編輯見源碼、預覽見效果」。
- 右上角「開啟／存入 HackMD」改為附圖的描邊式：極淺青白底＋淺青框＋深青字
  （比照深色模式原則，不再是實面綠底白字）。

## 第二輪變更（2026-09-25 主人第二輪試玩 3 項回饋）
